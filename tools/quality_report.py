...
def main() -> int:
    ...
    loc_by_area = []
    areas = [
        ("src/TaskbarUnhideZoner/Runtime", "src/TaskbarUnhideZoner/Runtime/"),
        ("src/TaskbarUnhideZoner/Services", "src/TaskbarUnhideZoner/Services/"),
        ("src/TaskbarUnhideZoner/Detection", "src/TaskbarUnhideZoner/Detection/"),
        ("src/TaskbarUnhideZoner/Tray", "src/TaskbarUnhideZoner/Tray/"),
        ("src/TaskbarUnhideZoner/UI", "src/TaskbarUnhideZoner/UI/"),
        ("tests", "tests/"),
    ]
    ...
    if lizard_err:
        ...
        for r in by_ccn[:top_n]:
            lines.append(
                f"| {r['ccn']} | {r['nloc']} | {r['length']} | {r['parameter_count']} | `{r['function']}` | `{r['file']}` |"
            )
        ...
        for r in by_len[:top_n]:
            lines.append(
                f"| {r['length']} | {r['ccn']} | {r['nloc']} | {r['parameter_count']} | `{r['function']}` | `{r['file']}` |"
            )
